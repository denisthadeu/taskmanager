...
class CronRunCommand extends Command {
	...
	public function fire()
	{
		...
		{
			Log::info('São 9 horas da manha');
		});

		$this->dailyAt('12:00', function()
		{
			Log::info('São 12 horas da manha');
		});

		$this->dailyAt('13:00', function()
		{
			Log::info('São 13 horas da manha');
		});

		$this->dailyAt('18:00', function()
		{
			Log::info('São 18 horas da manha');
		});
